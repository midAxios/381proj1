...
entity lbu is
    Port (
        ...
        rd       : out STD_LOGIC_VECTOR(31 downto 0)   -- loaded byte (zero-extended)
    );
end lbu;

architecture Behavioral of lbu is
...
begin
    ...
    -- Zero-extend loaded byte to 32 bits
    rd <= (31 downto 8 => '0') & mem_data;
